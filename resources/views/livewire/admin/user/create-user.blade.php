<div class="min-h-screen">
    ...
    <div class="flex justify-center items-center">
        <div class="flex bg-[#D4EAE6] p-6 rounded-lg shadow-lg sm:w-2/3 w-full flex-col md:flex-row">
            <div
                class="w-full md:w-1/3 flex flex-col justify-center bg-white rounded-lg p-4 sm:flex-col sm:flex-direction-column">
                <div
                    class="w-full h-48 flex items-center justify-center @if (!$image) border-2 border-dashed @endif border-gray-400 rounded-lg mb-4">
            ...
            <form wire:submit.prevent='save'
                ...
                <div class="flex justify-center gap-4">
                    ...
                    <button wire:loading.remove wire:target='save' type="submit"
                        class="bg-[#1BC300] hover:bg-[#18af00] text-white font-bold py-2 px-6 rounded-lg mt-2 sm:mt-4">Tambahkan</button>
